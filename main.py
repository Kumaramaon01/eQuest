...
def main(): 
    ...
    if st.session_state.script_choice == "about":
        ...
        with col5:
            ...
            st.markdown('<a href="https://drive.google.com/file/d/10jga6aMVQHgEIG1rhMaqs_sXTt3yEJXK/view?usp=drive_link"><button style="background-color:#4CAF50;color:white; border-radius: 7px; disabled">Download</button></a>', unsafe_allow_html=True)
        with col6:

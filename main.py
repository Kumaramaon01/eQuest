...
def main(): 
    ...
    if st.session_state.script_choice == "about":
        ...
        <b>Purpose:</b> The Schedule Generator is used to process SIM files generated by eQuest simulations. SIM files contain detailed results of energy simulations, including energy consumption, system performance, and cost estimates.<br>
        """, unsafe_allow_html=True)
        uploaded_file = st.file_uploader("Upload CSV or EXCEL file", type="csv", accept_multiple_files=True)

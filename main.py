...
def main(): 
    ...
    if st.session_state.script_choice == "about":
        ...
        with col1:
            ...
            st.image("images/INP_Parser_logo.png", width = 10)
        ...
        with col2:
            ...
            st.image("images/SIM_Parser_logo.png", width = 60)
        ...
        with col3:
            ...
            st.image("images/purging_inp_logo.png", width = 60)
            st.write("[Download](https://drive.google.com/file/d/1oIQmgVAMy871cwwQPnlm3FAAlEB_Bl7o/view?usp=drive_link)")
        with col4:
            # st.markdown("<h2>EXE 3</h2>", unsafe_allow_html=True)
            # st.write("Purging INP")
            st.image("images/SIM_pdf.png", width=60)  # Replace with the path to your logo file

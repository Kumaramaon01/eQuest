...
def main(): 
    ...
    if st.session_state.script_choice == "about":
        ...
        st.markdown("""
        <style>
            .header {color: #333; text-align: left; padding: 20px 0;}
            .section-title {color: #4CAF50; text-align: left; padding: 10px 0; font-weight: bold;}
            .download-button {background-color: #4CAF50; color: white; border-radius: 7px; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block;}
            .disabled-button {background-color: #9E9E9E; color: white; border-radius: 7px; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; cursor: not-allowed;}
            .image-container {text-align: center; padding: 10px;}
            .guidelines, .instructions {font-size: 16px; line-height: 1.6; padding: 10px 0;}
            .list-item {margin-bottom: 15px;}
            .note {color: #FF5722; font-weight: bold; padding: 10px 0;}
        </style>
    
        <h4 class="header">🖥️ EXE Files</h4>
        """, unsafe_allow_html=True)
        ...
        col1, col2, col3, col4, col5, col6 = st.columns([1, 1, 1, 1, 1, 1])
        with col1:
            st.markdown('<div class="image-container"><img src="images/INP_Parser_logo.png" width="110" /></div>', unsafe_allow_html=True)
            st.markdown('<a href="https://drive.google.com/file/d/1_jgaEfJCuoqfZOq3hY33D-3x31-v-nTH/view?usp=drive_link" class="download-button">Download</a>', unsafe_allow_html=True)
        with col2:
            st.markdown('<div class="image-container"><img src="images/SIM_Parser_logo.png" width="110" /></div>', unsafe_allow_html=True)
            st.markdown('<a href="https://drive.google.com/file/d/1XBb_NGFgjdRKM5WXwNWBwhRWmOYRzbT4/view?usp=sharing" class="download-button">Download</a>', unsafe_allow_html=True)
        with col3:
            st.markdown('<div class="image-container"><img src="images/purging_inp_logo.png" width="110" /></div>', unsafe_allow_html=True)
            st.markdown('<a href="https://drive.google.com/file/d/1oIQmgVAMy871cwwQPnlm3FAAlEB_Bl7o/view?usp=drive_link" class="download-button">Download</a>', unsafe_allow_html=True)
        with col4:
            st.markdown('<div class="image-container"><img src="images/SIM_pdf.png" width="110" /></div>', unsafe_allow_html=True)
            st.markdown('<a href="https://drive.google.com/file/d/10jga6aMVQHgEIG1rhMaqs_sXTt3yEJXK/view?usp=drive_link" class="download-button">Download</a>', unsafe_allow_html=True)
        with col5:
            st.markdown('<div class="image-container"><img src="images/baseline.png" width="110" /></div>', unsafe_allow_html=True)
            st.markdown('<a href="#" class="disabled-button">Download</a>', unsafe_allow_html=True)
        with col6:
            st.markdown('<div class="image-container"><img src="images/schedule.png" width="110" /></div>', unsafe_allow_html=True)
            st.markdown('<a href="https://drive.google.com/file/d/1wbN0f47EpBKY95Q1IZiOUFi2rYQQ7NsM/view?usp=sharing" class="download-button">Download</a>', unsafe_allow_html=True)
        
        # Adding spacing for better layout
        st.markdown("<br>", unsafe_allow_html=True)
    
        st.markdown("""
            <h5 class="section-title">📄 Guidelines for EXE Files</h5>
        ...
        st.markdown("""
            <h5 class="section-title">📄 Instructions for Executing EXE Files</h5>
            <div class="instructions">
                <p>Please follow these instructions to execute the EXE files effectively:</p>
                <ul style="list-style-type:disc; padding-left:20px;">
                    <li class="list-item">
                        <b>SIM to PDF:</b> Ensure all SIM files are located in the same folder. After entering the report name and folder path, the program will create a new folder named "Output Reports" within the SIM files folder. This new folder will contain PDFs and sliced SIM files.
                    </li>
        ...
        st.markdown("""
            <div class="note">
                <p><b>Note:</b> Due to the large size of eQuest Utilities EXE files, they may not be suitable for direct hosting on our website. However, they are available for download.</p>
            </div>
            """, unsafe_allow_html=True)

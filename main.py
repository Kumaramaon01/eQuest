...
def main():
    ...
    <div style="text-align:center">
        <span style="font-size:44px">
            <a href="https://mail.google.com/mail/u/0/#inbox" title="Reach out for any queries" onmouseover="if (confirm('Do you want to ask a question?')) { window.sessionStorage.setItem('script_choice', 'ask'); }">&#x1F4AC;</a>
        </span>
    </div>
    """

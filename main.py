...
def main(): 
    ...
    if st.session_state.script_choice == "about":
        ...
        with col1:
            ...
            st.markdown('<a href="https://drive.google.com/file/d/1_jgaEfJCuoqfZOq3hY33D-3x31-v-nTH/view?usp=drive_link"><button style="background-color:#4CAF50;color:white;">Download</button></a>', unsafe_allow_html=True)
        with col2:
        ...
        st.markdown("""
            ...
            <p style="text-align:justify;">
                To run the executable files (.exe) correctly, follow these steps:
            </p>
            <ul style="list-style-type:disc; padding-left:20px;">
                <li style="margin-bottom:10px;">
                    <b>Locate the File:</b> Ensure that the .exe file is located in the same directory as your input files (.inp) for optimal functionality.
                </li>
                <li style="margin-bottom:10px;">
                    <b>Open Command Prompt:</b> Double-click on the .exe file, which will automatically open a Command Prompt window.
                </li>
                <li style="margin-bottom:10px;">
                    <b>Provide Input Files:</b> Make sure all required input files are present in the same directory as the executable file. The program will process these files as specified.
                </li>
                <li style="margin-bottom:10px;">
                    <b>Execute Commands:</b> Follow any prompts or commands that appear in the Command Prompt window to guide the program’s execution.
                </li>
                <li style="margin-bottom:10px;">
                    <b>Check Output:</b> After execution, check the output files or results generated by the program, which will be saved in the same directory.
                </li>
                <li style="margin-bottom:10px;">
                    <b>Troubleshooting:</b> If you encounter issues, refer to the program's user manual or troubleshooting guide for further assistance.
                </li>
            </ul>
            """, unsafe_allow_html=True)

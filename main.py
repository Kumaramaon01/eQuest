...
def main(): 
    ...
    if st.session_state.script_choice == "about":
        ...
        with col1:
            ...
            st.image("images/INP_Parser_logo.png", width = 90)
        ...
        with col2:
            ...
            st.image("images/SIM_Parser_logo.png", width = 90)

...
def main(): 
    ...
    st.markdown(
        ...
        <svg height="100" width="100%">
          ...
          <animateTransform attributeName="transform" attributeType="XML" type="rotate" from="0" to="30" begin="10s" dur="30s" repeatCount="indefinite"/>
        </svg>
        """,
        unsafe_allow_html=True
    )

    col1, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11 = st.columns([0.9, 1, 1, 1, 0.9, 0.9, 0.9, 1.6, 1, 0.7, 0.7])
    with col1:
        if st.button("Home"):

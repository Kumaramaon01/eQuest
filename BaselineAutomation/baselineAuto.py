...
def main(input_inp_path, input_sim_path, input_climate, input_building_type, input_area, floor, heat_type, output_file_path):
    ...
    system_path = update_MLC.get_system_path(input_building_type, heat_type, input_area, floor)
...
# Example usage (remove/comment out this part if running in a different context)
...
#     output_file_path = "path/to/output/file.inp"
    
#     main(input_inp_path, input_sim_path, input_climate, input_building_type, input_area, floor, heat_type, output_file_path)
